  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        const SizedBox(width: 8), // Jarak antara indikator dan teks
        Text(
          text,
          style: TextStyle(
            color: textColor,
...
class AppColors {
  static const contentColorBlue = Color.fromARGB(255, 167, 143, 255);
  static const contentColorYellow = Color.fromARGB(255, 255, 116, 236);
  static const contentColorPink = Color.fromARGB(255, 172, 191, 255);
  static const contentColorGreen = Color.fromARGB(255, 106, 76, 175);
